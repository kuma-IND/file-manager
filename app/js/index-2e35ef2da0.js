...
function openConfirmDeleteModal(ele) {
    ...
    gui += "</div>";
    gui += "<div class='modal-footer'>";
    gui += "<button type='submit' id='confirm_file_delete' data-file_name='"+ele.closest("tr").find()+"' class='btn btn-" + color + "'>Yes</button>";
...
//# sourceMappingURL=index-2e35ef2da0.js.map
