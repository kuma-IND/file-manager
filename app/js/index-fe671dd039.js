...
function displayUserFiles(json_ob) {
    ...
    $.each(json_ob.user_files.files, function (i, file) {
        ...
        gui += "</td>";
        gui += "<td>" + file.name + "<a target='_blank' href='../classes/user.php?operation=download_file&f=" + file.name + "' class='pull-right'><i class='fa fa-download'></i></a></td>";
...
//# sourceMappingURL=index-fe671dd039.js.map
