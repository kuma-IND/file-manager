...
function uploadFiles() {
    ...
    progress_bar += "<div class='progress-bar progress-bar-warning progress-bar-striped active' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100' style='width: 0%'>";
    progress_bar += "0%";
        ...
        xhr: function () {
            ...
            xhr.upload.addEventListener('progress', function (ev) {
                if (ev.lengthComputable) {
                    ...
                    if (form_modal.find(".modal-footer .progress").length === 0) {
                        form_modal.find(".modal-footer").prepend("<div class='pull-left'>" + progress_bar + "</div>");
                    }

                    var percentage = Math.round(ev.loaded / ev.total * 100);
                    changeProgressBarStatus(form_modal.find(".modal-footer .progress-bar"), percentage);
                    if (percentage === 100) {
                        savingProgressBarStatus(form_modal.find(".modal-footer .progress-bar"));
                    }
                }
            });
            return xhr;
...
//# sourceMappingURL=index-840ea40ad6.js.map
