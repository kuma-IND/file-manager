...
function displayUserFiles(json_ob) {
    ...
    $.each(json_ob.user_files.files, function (i, file) {
        ...
        gui += "</td>";
        gui += "<td><a target='_blank' href='../files/" + logged_in_object.id + "/" + file.name + "'>" + file.name + "</a></td>";
...
function uploadFiles(file) {
    var file_data = file;//$('#user_file').prop('files')[0];
...
//# sourceMappingURL=index-5987b73d46.js.map
