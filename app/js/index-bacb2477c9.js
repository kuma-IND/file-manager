...
function updateSelectedFileTable(files) {
        ...
        if (!max_files_count_error) {
            ...
            if (!found) {
                if (selected_files.length < file_constraints.max_files_count) {
                    if (file.size < file_constraints.max_files_count) {
    ...
    if (max_files_count_error) {
        ...
        showAlert(setError("Can't add file larger than " + file_constraints.max_files_count + " "));
    }
...
//# sourceMappingURL=index-bacb2477c9.js.map
