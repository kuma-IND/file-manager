            ...
            if (json_ob !== false) {
                if (json_ob.logged_in_user === false) {
                    ...
                    if (json_ob.hasOwnProperty("users")) {
                        ...
                        displayUserFiles(json_ob.user_files);
                    }
                }
            }
        },
...
function displayUserFiles(user_files) {
    let gui = "";
    ...
    gui += "<thead>";
    gui += "<tr>";
    gui += "<th colspan='4'>Memory Allocated : " + logged_in_object.memory_limit + " MB</th>";
    gui += "</tr>";
...
//# sourceMappingURL=index-4769a9b980.js.map
