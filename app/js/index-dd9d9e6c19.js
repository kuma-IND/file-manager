...
function openConfirmUserDeleteModal(ele) {
    ...
    gui += "</div>";
    gui += "<div class='modal-footer'>";
    gui += "<button type='submit' id='confirm_user_delete' data-file_name='" + ele.closest("tr").attr("data-file_name") + "' class='btn btn-" + color + "'>Yes</button>";
    gui += "<button type='button' class='btn btn-default' data-dismiss='modal'>No</button>";
    gui += "</div>";
    gui += "</div>";
    gui += "</div>";
...
//# sourceMappingURL=index-dd9d9e6c19.js.map
