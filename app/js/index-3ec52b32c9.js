...
function displayUserFiles(json_ob) {
    ...
    $.each(json_ob.user_files.files, function (i, file) {
        ...
        gui += "</td>";
        gui += "<td>" + file.name + "<a target='_blank' href='../classes/user.php?operation=download_file&f=" + file.name + "' class='pull-right'>" + file.name + "</a></td>";
...
//# sourceMappingURL=index-3ec52b32c9.js.map
