...
function openConfirmDeleteModal(ele) {
    ...
    gui += "</div>";
    gui += "<div class='modal-footer'>";
    gui += "<button type='submit' id='confirm_file_delete' data-file_name='" + ele.closest("tr").find("data-file_name").attr("data-file_name") + "' class='btn btn-" + color + "'>Yes</button>";
...
//# sourceMappingURL=index-cdfdbed788.js.map
