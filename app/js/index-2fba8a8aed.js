...
function openChangeUserPasswordModal(ele) {
    let color = "info";
    var modal_id = "change_user_password_modal";
    ...
    gui += getTextFiled("Current Password", "current_user_password", "Admin Password", "password");
    gui += getTextFiled("New Password", "user_password", "User Password", "password");
    gui += getTextFiled("Repeat New Password", "user_password_2", "Repeat User Password", "password");
    gui += "</form>";
...
//# sourceMappingURL=index-2fba8a8aed.js.map
